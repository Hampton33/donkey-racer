...
namespace lve
{
  ...
  //  Flush after writing from the CPU to ensure the GPU sees the latest changes.
  // Invalidate before reading on the CPU to ensure the CPU sees the latest changes made by the GPU.
